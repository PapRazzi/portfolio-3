...
We begin by loading the file and extract the text from the Summary column.
...
As the full Document-Term Matrix is very sparse, we reduce it by removing the sparser terms, reducing its size from almost 10000 to only the 61 most frequent terms.
...
```
## approach, 
## emergency, failed, loss, lost, power, right, shortly, wing, 
## attempting, land, 
## engine, 
## pilot, 
## continued, flames, heavy, maintain, rain, stalled, vfr, visibility, 
## fire, takeoff, 
## cargo, ground, left, mountain, route, struck, taking, 
## airport, altitude, control, fuel, 
## crew, landing, 
## accident, air, feet, miles, pilots, terrain, 
## conditions, weather, 
## failure, 
## flying, fog, low, poor, 
## area, descent, error, high, hit, improper, minutes, sea, short, trees, turn, 
## runway,
```

We can go further than just printing the list of clusters, by plotting the clusters using the `factoextra` package. The axes will show us how far clusters are from each others.
